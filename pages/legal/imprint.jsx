            ...
            <div className="text-image-box scroller scroller-wait">
                <div className="box-text">
                    <div style={{userSelect: "text"}}>
                        <b>Contact</b><br/>
                        <div className="secure-image-container" style={{position: "relative", display: "inline-block"}}>
                            <img src="/images/banner/contact-ABHqZyZyOrUu.png" alt="contact-data" style={{display: "block", width: "100%", height: "auto"}}/>
                            <div className="overlay" style={{position: "absolute", top: "0", left: "0", width: "100%", height: "100%"}}/>
                        </div><br/>
                        <b style={{userSelect: "text"}}>EU-Dispute-Settlement</b><br/>
